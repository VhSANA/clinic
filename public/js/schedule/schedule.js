document.addEventListener('DOMContentLoaded', function () {
    const { calendars, schedules, personnels, rules, rooms, validation } = window.scheduleData || {};

    console.log(calendars, schedules, personnels, rules, rooms);
    console.log(validation.addSchedule, validation.selectedPersonnelId, validation.editSchedule);
    ...
    function getPersianWeekRange(date) {
...
// schedule
    ...
    function displaySelectedPersonnel(personnel) {
        ...
        for (let date = new Date(startOfWeek); date <= endOfWeek; date.setDate(date.getDate() + 1)) {
            console.log(currentDate, startOfWeek, endOfWeek,date)
